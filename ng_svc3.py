...
*condicao inicial  = 0V
va fa 0 dc 0 sin(0 {tensao} {freq} 0 0 0)
vb fb 0 dc 0 sin(0 {tensao} {freq} 0 0 -120)
vc fc 0 dc 0 sin(0 {tensao} {freq} 0 0 120)

*impedandia do ponto de conexao
*forte
rscla fa lfa 1.4
rsclb fb lfb 1.4
rsclc fc lfc 1.4
...
vmando b_mando 0 dc 0 pwl(0 -1 12 1)
...
l5b sb n_l5b 919u
l5c sc n_l5c 919u
r5a n_l5a n_c5a 0.00133
r5b n_l5b n_c5b 0.00133
r5c n_l5c n_c5c 0.00133
...
l3b sb n_l3b 1.907m
l3c sc n_l3c 1.907m
r3a n_l3a n_c3a 0.002876
r3b n_l3b n_c3b 0.002876
r3c n_l3c n_c3c 0.002876
...
*--snuber-------------------------------------
rs n_sist1 n_snuber 450
cs n_snuber n_carga 0.073u
...
rperda n_perda n_cap 0.0034	;resistencia de 0.011 ohm em serie
